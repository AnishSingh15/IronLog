      ...
      >
        ...
        <div className="space-y-2 font-mono text-sm">
          ...
          <div>
            ...
            <code className="bg-white p-1 rounded">{process.env.NODE_ENV || 'NOT SET'}</code>
          </div>
        </div>
        ...
        {!process.env.NEXT_PUBLIC_API_URL && (
          <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded">
            ...
            <ol className="list-decimal list-inside text-sm text-red-700 mt-2 space-y-1">
              <li>
                Go to{' '}
                <a href="https://vercel.com/dashboard" className="underline">
                  Vercel Dashboard
                </a>
              </li>
      ...
      <div className="mt-6 bg-blue-100 p-4 rounded-lg">
        ...
        <div className="space-y-2 font-mono text-sm">
          <div>
            ...
            <code className="bg-white p-1 rounded">https://ironlog.onrender.com/api/v1</code>
          </div>
          <div>
            <strong>NODE_ENV should be:</strong>{' '}
            <code className="bg-white p-1 rounded">production</code>
          </div>
        </div>
      </div>
