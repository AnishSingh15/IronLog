...
async function injectAnishWorkouts() {
  try {
    console.log('🚀 Starting workout injection for Anish...');
    ...
    console.log('🎉 Workout injection completed successfully!');
    console.log(`📊 Summary:`);
    ...
    console.error('❌ Error injecting workouts:', error);
    throw error;
  } finally {
...
export default injectAnishWorkouts;
